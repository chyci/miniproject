...
mutation MyMutation($id: Int = 10, $transaction_name: String = "", $price: bigint = "", $date: String = "") {
    update_Transaction_by_pk(pk_columns: {id: $id}, _set: {transaction_name: $transaction_name, price: $price, date: $date}) {
      transaction_name
      date
      price
    }
